...
PRINT_DOCKER_CMD=${PRINT_DOCKER_CMD:1}
SSL_CERT=${SSL_CERT:-}
SSL_KEY=${SSL_KEY:-}
SPLUNK_START_ARGS=${SPLUNK_START_ARGS:--accept-license}
SPLUNK_ML=${SPLUNK_ML:1}
REST_KEY=${REST_KEY:9C66BF58B92EF9CE013966B9C4D602D10921902461}
SPLUNK_EVENTGEN=${SPLUNK_EVENTGEN:1}
SPLUNK_LOGS=${SPLUNK_LOGS:~/Projects/splunk/logs}
